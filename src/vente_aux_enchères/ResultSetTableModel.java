...
public class ResultSetTableModel extends AbstractTableModel {
    ...
    public int getColumnCount() {
        try {
            ...
            System.out.println("getColumncount resultset renerating error while getting column count");
    ...
    public String getColumnName(int columnIndex) {
        try {
            ...
            System.out.println("getColumnname resultset generating errr while fetching column name");
           System.out.println(e.getMessage());
        }
